...
view : Model -> Html Msg
view model =
    div [ class "pages__page-color" ] [ renderColors model ]
...
renderColors model =
    article [ class "pages__page-color__section" ]
        ...
        , ul
            [ class "pages__page-color__section__list"
            ]
...
renderColor colorCopied ({ color, variant } as pyxisColor) =
    li
        [ classList [ ( "pages__page-color__section__list__item", True ), ( "colorCopied", colorCopied ) ] ]
        [ renderSample pyxisColor
        , div
            [ class "pages__page-color__section__list__item__body" ]
            [ renderName color
...
renderSample pyxisColor =
    div
        [ class "pages__page-color__section__list__item__sample"
...
renderName color =
    span [ class "pages__page-color__section__list__item__name" ] [ text <| colorToLabel color ]


renderVariant : Variant -> Html Msg
renderVariant variant =
    span [ class "pages__page-color__section__list__item__variant" ] [ text <| variantToLabel variant ]


renderHexRGB : PyxisColor -> Html Msg
renderHexRGB pyxisColor =
    div
        [ class "pages__page-color__section__list__item__copyable"
        , onClick (CopyToClipboard pyxisColor)
        ]
        [ span [ class "pages__page-color__section__list__item__copyable__text" ] [ text (pyxisColorToHexRGB pyxisColor) ]
        , span [ class "pages__page-color__section__list__item__copyable__icon icon-sheet" ] []
        ]
